...
<body class="bg-primary-1">
    <div class="flex w-full justify-center my-5 gap-8">
        <div class="profile-container w-45">
            <form action="/profile/edit/<?= $user['user_id']; ?>" method="post" enctype="multipart/form-data" class="bg-secondary-1 p-8 rounded-8">
        ...
        <div class="profile-container w-45">
            <form action="/profile/edit/password/<?= $user['user_id']; ?>" method="post" class="bg-secondary-1 p-8 rounded-8">
                <h2 class="font-bold text-center text-primary-1 text-4xl mb-5">Change Password</h2>
                <div class="flex flex-column gap-3">
                    <div class="flex flex-column gap-1">
                        <label for="password" class="text-primary-1 text-2xl">Old Password</label>
                        <input type="password" name="password" id="password" class="bg-secondary-2 py-3 px-5 rounded-4 text-xl font-regular text-primary-1" required>
                    </div>
                    <div class="flex flex-column gap-1">
                    ...
                    <div class="flex flex-column gap-1">
                        <label for="password_confirm" class="text-primary-1 text-2xl">New Password</label>
